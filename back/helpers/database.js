...
/**
 * Виконує callback в транзакції та повертає результат
 * На відміну від tx(), ця функція повертає результат callback
 * та прокидує оригінальну помилку для кращої діагностики
 */
const withTransaction = async (callback) => {
    ...
    try {
        ...
        await client.query('ROLLBACK');
        throw e; // Прокидуємо оригінальну помилку
    } finally {
        client.release();
    }
};
