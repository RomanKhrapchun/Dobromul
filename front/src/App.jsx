...
const ChildrenRoster = lazy(() => import('./pages/Kindergarten/Shared/ChildrenRoster.jsx'));
const Attendance = lazy(() => import('./pages/Kindergarten/Shared/Attendance.jsx'));
const PastAttendance = lazy(() => import('./pages/Kindergarten/Shared/PastAttendance.jsx'));
const ChildProposals = lazy(() => import('./pages/Kindergarten/ChildProposals.jsx'));
const ChildBenefits = lazy(() => import('./pages/Kindergarten/ChildBenefits.jsx'));
// Sports complex
...
// Parking
const BookingList = lazy(() => import('./pages/Parking/BookingList'));
const CheckHistoryList = lazy(() => import('./pages/Parking/CheckHistoryList'));
// Community Settings
const CommunitySettings = lazy(() => import('./pages/CommunitySettings/CommunitySettings'));
const OwerSettings = lazy(() => import('./pages/OwerSettings/OwerSettings'));
// SMS
const SMSList = lazy(() => import('./pages/SMS/SMSList'));
// Tax Reports
const TaxReports = lazy(() => import('./pages/TaxReports/TaxReports'));
// Court Order
const CourtOrder = lazy(() => import('./pages/CourtOrder/CourtOrder'));
        ...
        <BrowserRouter>
            <Routes>
                <Route exact path="/" element={<Home />}>
                    ...
                    <Route exact path="kindergarten/:kindergartenId/daily_food_cost" element={<Suspense fallback={<Loader/>}><DailyFoodCost /></Suspense>} />
                    ...
                    <Route exact path="kindergarten/:kindergartenId/childrenRoster" element={<Suspense fallback={<Loader/>}><ChildrenRoster /></Suspense>} />
                    <Route exact path="kindergarten/:kindergartenId/attendance" element={<Suspense fallback={<Loader/>}><Attendance /></Suspense>} />
                    <Route exact path="kindergarten/:kindergartenId/past_attendance" element={<Suspense fallback={<Loader/>}><PastAttendance /></Suspense>} />
                    <Route exact path="kindergarten/proposals" element={<Suspense fallback={<Loader/>}><ChildProposals /></Suspense>} />
                    <Route exact path="kindergarten/benefits" element={<Suspense fallback={<Loader/>}><ChildBenefits /></Suspense>} />
                    {/* Districts Routes */}
                    ...
                    {/* Parking */}
                    <Route path="parking/bookings" element={<Suspense fallback={<Loader />}><BookingList /></Suspense>} />
                    <Route path="parking/check-history" element={<Suspense fallback={<Loader />}><CheckHistoryList /></Suspense>} />
                    {/* Community Settings */}
                    <Route path="settings/community" element={<Suspense fallback={<Loader />}><CommunitySettings /></Suspense>} />
                    <Route path="settings/requisites" element={<Suspense fallback={<Loader />}><OwerSettings /></Suspense>} />
                    {/* SMS */}
                    <Route path="sms" element={<Suspense fallback={<Loader />}><SMSList /></Suspense>} />
                    {/* Tax Reports */}
                    <Route exact path="debtor-register" element={<Suspense fallback={<Loader />}><TaxReports /></Suspense>} />
                    {/* Court Order */}
                    <Route exact path="court-order" element={<Suspense fallback={<Loader />}><CourtOrder /></Suspense>} />
