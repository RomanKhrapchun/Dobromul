...
const KindergartenGroups = () => {
    ...
    // ✅ ДОДАНО: Стан для списку садочків та груп
    ...
    // ✅ ДОДАНО: Завантаження унікальних назв садочків та груп
    useEffect(() => {
        const loadKindergartensAndGroups = async () => {
            try {
                ...
                if (response?.data && Array.isArray(response.data.items)) {
                    ...
                    const groupOptions = uniqueGroups.map(name => ({
                        value: name,
                        label: name
                    }));
                ...
                console.error('Error loading kindergartens and groups:', error);
                setKindergartensData([]);
                setGroupsData([]);
            }
        };
        loadKindergartensAndGroups();
    }, []);
                        ...
                        <div className="table-header">
                            ...
                            <div className="table-header__buttons">
                                ...
                                <FilterDropdown
                                    ...
                                    title="Фільтри груп"
                                >
                                    {/* Кастомні фільтри для Kindergarten Groups */}
                                    <div className="filter-dropdown__item">
                                        ...
                                        <Select
                                            ...
                                            value={
                                                stateKindergarten.selectData.kindergarten_name
                                                    ? kindergartensData.find(k => k.value === stateKindergarten.selectData.kindergarten_name)
                                                    : null
                                            }
                                    ...
                                    <div className="filter-dropdown__item">
                                        ...
                                        <Select
                                            ...
                                            value={
                                                stateKindergarten.selectData.group_name
                                                    ? groupsData.find(g => g.value === stateKindergarten.selectData.group_name)
                                                    : null
                                            }
                                            onChange={(name, option) => onHandleChange(name, option?.value || null)}
                                            options={groupsData}
                                    ...
                                    <div className="filter-dropdown__item">
                                        <label className="filter-dropdown__label">Тип групи</label>
                                        <Select
                                            name="group_type"
                                            ...
                                            value={
                                                stateKindergarten.selectData?.group_type ?
                                                    (stateKindergarten.selectData.group_type === 'young'
                                                        ? { value: 'young', label: 'Молодша' }
                                                        : stateKindergarten.selectData.group_type === 'older'
                                                        ? { value: 'older', label: 'Старша' }
                                                        : { value: '', label: 'Всі типи' }
                                                    )
                                                    : null
                                            ...
                                            onChange={(name, value) => {
                                                ...
                                                onHandleChange(name, selectedValue);
                                            }}
                                            style={dropDownStyle}
                                        />
                                    </div>
